...
function loadCSV() {
    Papa.parse('DN koko excel cvs.csv', {
        ...
        complete: function(results) {
            ...
            data = results.data;
            console.log('Parsed CSV data:', data); // Tulostaa datan konsoliin
            populateDropdowns();
        },
...
function populateDropdowns() {
    ...
    // Tyhjennä valikot ennen uudelleentäyttöä
    dnSelect.innerHTML = '<option value="">-- Valitse DN --</option>';
    outerDiameterSelect.innerHTML = '<option value="">-- Valitse Ulkohalkaisija --</option>';
    inchSizeSelect.innerHTML = '<option value="">-- Valitse Tuumakoko --</option>';
    ...
    data.forEach(row => {
        ...
        // Ulkohalkaisija-valikko
        if (row.Ulkohalkaisija) { // Muutettu 'Ulkohalkaisija (mm)' -> 'Ulkohalkaisija'
...
function updateResults() {
    ...
    if (dnSelect) {
        ...
        selectedRow = data.find(row => row.Ulkohalkaisija === outerDiameterSelect); // Muutettu
    ...
    if (selectedRow) {
        ...
        document.getElementById('result-outer-diameter').textContent = `Ulkohalkaisija: ${selectedRow.Ulkohalkaisija}`; // Muutettu
